...
import { Link } from "react-router-dom";
import { Instagram, ArrowUp, Phone, Mail, MapPin, Heart } from "lucide-react";
import { categories } from "@/data/products";
  ...
  return (
    <footer className="bg-primary text-cream/80">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        ...
        {/* Bottom */}
        <div className="mt-12 pt-8 border-t border-gold/20 flex flex-col md:flex-row justify-between items-center gap-6">
